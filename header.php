...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav m-auto">
      <li class="nav-item active dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="User/register.php"><button class="btn btn-warning text-white btn-lg btn-block logbtn">LOGIN</button></a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="User/register.php"><button class="btn btn-dark text-white btn-lg btn-block">REGISTER</button></a>
        </div>
      </li>
      <li class="nav-item active dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <a href="User/cart.php" class="py-2 rounded-pill bg-dark border border-dark">
